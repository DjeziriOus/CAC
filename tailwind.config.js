...
export default {
  ...
  theme: {
  	...
  	extend: {
  		filter: {
  			'custom-ribbon': 'brightness(0) saturate(100%) invert(48%) sepia(81%) saturate(427%) hue-rotate(338deg) brightness(93%) contrast(91%)'
  		},
  		screens: {
  			'4xl': '1920px',
  			'3xl': '1600px',
  		...
  		boxShadow: {
  			...
  			question: '0px 4px 8px 0px rgba(10, 58, 100, 0.15)'
  		},
  		colors: {
